...
namespace System.Linq.Dynamic
{
    public static class DynamicQueryable
    {
        ...
        /// </remarks>
        public static DataTable ToDataTable<T>(this IEnumerable<T> source, bool useDisplayNames = false)
        {
            return new ObjectShredder<T>().Shred(source, null, null, useDisplayNames);
        }
        ...
        /// If the source sequence contains a sub-type of T, the table is automatically expanded for any addition public properties or fields.
        /// </remarks>
        public static DataTable LoadSequence<T>(this IEnumerable<T> source, DataTable table, LoadOption? options)
        {
            if (table == null)
    ...
    internal class ClassFactory
    {
        ...
        FieldInfo[] GenerateProperties(TypeBuilder tb, DynamicProperty[] properties)
        {
            ...
            for (int i = 0; i < properties.Length; i++)
            {
                ...
                PropertyBuilder pb = tb.DefineProperty(dp.Name, Reflection.PropertyAttributes.HasDefault, dp.Type, null);
