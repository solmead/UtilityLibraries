...
namespace Utilities.AspNetCore.Identity.Repo
{
    ...
    public class UserOnlyStore : UserOnlyStore<AppUser<string>, AppRole<string>, string>
    {
        /// <summary>
    ...
    //    /// <param name="context">The <see cref="DbContext"/>.</param>
    //    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    //    public UserOnlyStore(IIdentityRepository<TUser, IdentityRole<TKey>, TKey> context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    //}
    /// <summary>
    /// Represents a new instance of a persistence store for the specified user and role types.
    /// </summary>
    ...
    /// <typeparam name="TContext">The type of the data context class used to access the store.</typeparam>
    /// <typeparam name="TKey">The type of the primary key for a role.</typeparam>
    public class UserOnlyStore<TUser, TRole, TKey> : UserOnlyStore<TUser, TRole, TKey, AppUserClaim<TKey>, AppUserLogin<TKey>, TwoFactorToken<TKey>>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public UserOnlyStore(IIdentityRepository<TUser, TRole, TKey> context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class UserOnlyStore<TUser, TRole, TKey, TUserClaim, TUserLogin, TUserToken> :
        ...
        where TUser : AppUser<TKey>
        where TRole : AppRole<TKey>
        where TUserLogin : AppUserLogin<TKey>, new()
        where TUserClaim : AppUserClaim<TKey> , new()
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public UserOnlyStore(IIdentityRepository<TUser, TRole, TKey> context, IdentityErrorDescriber describer = null) : base(describer ?? new IdentityErrorDescriber())
        {
            if (context == null)
            {
        ...
        public async override Task<IdentityResult> DeleteAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await Context.DeletePersonAsync(user);
        ...
        {
            return Context.FindAsync(userId);
