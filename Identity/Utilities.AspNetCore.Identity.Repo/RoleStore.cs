...
namespace Utilities.AspNetCore.Identity.Repo
{
    ...
    public class RoleStore : RoleStore<AppUser<string>, AppRole<string>, string>
    {
        /// <summary>
        ...
        public RoleStore(IIdentityRepository<AppUser<string>, AppRole<string>, string> context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    //    /// <param name="context">The <see cref="DbContext"/>.</param>
    //    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    //    public RoleStore(IIdentityRepository<AppUser<string>, TRole, string> context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    //}
    ...
    //    /// <param name="context">The <see cref="DbContext"/>.</param>
    //    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    //    public RoleStore(IIdentityRepository<AppUser<TKey>, TRole, TKey> context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    //}

    public class RoleStore<TUser, TRole, TKey> : RoleStore<TUser, TRole, TKey, IdentityUserRole<TKey>, IdentityRoleClaim<TKey>>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public RoleStore(IIdentityRepository<TUser, TRole, TKey> context, IdentityErrorDescriber describer = null) : base(context, describer) { }
    }
    ...
    public class RoleStore<TUser, TRole, TKey, TUserRole, TRoleClaim> :
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public RoleStore(IIdentityRepository<TUser, TRole, TKey> context, IdentityErrorDescriber describer = null)
        {
            if (context == null)
            {
        ...
        public async virtual Task<IdentityResult> DeleteAsync(TRole role, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            //await Context.DeleteRoleAsync(role);
        ...
        public virtual Task<TRole> FindByNameAsync(string normalizedName, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Context.FindRoleByNameAsync(normalizedName);
